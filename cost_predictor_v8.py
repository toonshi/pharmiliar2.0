...
from service_mapper_v4 import ServiceMapper
...
class CostPredictor:
    ...
    def analyze_symptoms(self, symptoms: str) -> Dict:
        ...
        3. Use ONLY these service types for required_services:
           ...
           - Ward admission
           - ICU
        4. For each service, include alternative names and common terms
        ...
        try:
            response = client.chat.completions.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are a medical cost analysis assistant. Use only the specified service types."},
