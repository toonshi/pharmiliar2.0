...
class ServiceMapper:
    def __init__(self):
        ...
        self.service_mappings = {
            ...
            "Consultation": {
                "terms": ["Consultation", "Consultancy"],
                "exclude": ["Blood Sugar"],
                "categories": ["1", "18", "19", "20", "CLINICS", "FILTER CLINIC", "OUT PATIENT"]
            },
            "Pain medication": {
                "terms": ["Pain", "Paracetamol", "Brufen", "Analgesic"],
                "exclude": ["Painting", "Art", "Peg"],
                "categories": ["PHARMACY 24HR -DRUGS", "ADULT PHARMACY", "INPATIENT PHARMACY"]
            },
            "Blood tests": {
                "terms": ["Blood", "Haemoglobin", "Hb", "Complete Blood Count", "CBC"],
                "exclude": ["Sugar", "Consultation"],
                "categories": ["LABORATORY GENERAL", "11", "12"]
            },
            "Injection": {
                "terms": ["Injection", "Inj"],
                "exclude": [],
                "categories": ["PHARMACY 24HR -DRUGS", "OUT PATIENT", "CASUALTY"]
            },
            ...
            "Physical exam": {
                ...
                "categories": ["CLINICS", "OUT PATIENT", "FILTER CLINIC"]
            },
            "CT scan": {
                "terms": ["CT", "Scan"],
                "exclude": [],
            ...
            "Dressing": {
                ...
                "exclude": [],
                "categories": ["PHARMACY24 HR NON DRUGS", "CASUALTY", "107", "108", "109", "110"]
            },
