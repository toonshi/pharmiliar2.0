...
class ServiceMapper:
    def __init__(self):
        ...
        self.service_mappings = {
            ...
            "Injection": {
                ...
                "exclude": [],
                "categories": ["PHARMACY 24HR -DRUGS", "OUT PATIENT", "CASUALTY", "PHARMACY", "PROCEDURE"]
            },
            ...
            "CT scan": {
                ...
                "exclude": [],
                "categories": ["XRAY", "RADIOLOGY", "IMAGING"]
            },
            "MRI": {
            ...
            "IV line": {
                "terms": ["Branula", "IV", "Cannula", "Intravenous", "Line", "Drip"],
                "exclude": [],
            ...
            "Urine test": {
                ...
                "exclude": [],
                "categories": ["LABORATORY GENERAL", "LAB", "LABORATORY"]
            },
            "Blood sugar": {
            ...
            "Ward admission": {
                ...
                "categories": [
                    ...
                    "INPATIENT WARD", "24", "WARD"
                ]
            },
            "ICU": {
                "terms": ["ICU", "I.C.U", "Intensive", "Critical care"],
                "exclude": [],
                "categories": ["I.C.U", "ICU", "CRITICAL CARE"]
            }
        }
    ...
    def find_matching_services(self, medical_term: str) -> List[Dict]:
        ...
        for category in mapping["categories"]:
            ...
            params = [category, f"%{category}%"]  # Added fuzzy category matching
